...
import { apiClient, ApiKeyResponse, ApiKeyCreateResponse } from '../lib/api'
      ...
      {createdKey && (
        <div className="alert alert-success">
          ...
          <div className="mt-sm">
            ...
            <button onClick={() => setCreatedKey(null)} className="btn btn-secondary">
              Close
            </button>
          </div>
        </div>
            ...
            {keys.map((key) => (
              <tr key={key.key_id}>
                ...
                <td className="table-cell-right">
                  {!key.revoked_at && (
                    <button onClick={() => handleRevoke(key.key_id)} className="btn btn-danger btn-sm">
                      Revoke
                    </button>
                  )}
                </td>
