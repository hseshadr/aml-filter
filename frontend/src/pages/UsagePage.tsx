  ...
  return (
    <div>
      <div className="page-header">
        ...
        <select value={days} onChange={(e) => setDays(parseInt(e.target.value))} className="form-select" style={{ width: 'auto' }}>
        ...
        <div>
          ...
          >
            <div className="stat-card">
              ...
              <div className="stat-value">{usage.total_units.toLocaleString()}</div>
            </div>
          </div>
              ...
              <table className="table">
                ...
                <tbody>
                  {Object.entries(usage.summary).map(([eventType, count]) => (
                    <tr key={eventType}>
                      <td>{eventType}</td>
                      <td className="table-cell-right">{count.toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
