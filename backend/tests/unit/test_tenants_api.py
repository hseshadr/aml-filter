...
async def test_create_tenant_success():
    ...
    payload = {"tenant_id": "new-tenant", "name": "New Tenant Corp", "plan": "professional"}
...
async def test_create_tenant_conflict():
    ...
    payload = {"tenant_id": "existing-tenant", "name": "Existing", "plan": "starter"}
...
async def test_create_tenant_invalid_plan():
    ...
    payload = {"tenant_id": "new-tenant", "name": "New", "plan": "invalid-plan"}
