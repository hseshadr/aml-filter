...
async def test_create_batch_job_success():
    ...
    with patch("aml_filter.api.v1.batch.BatchParser.parse") as mock_parse, \
         patch("aml_filter.api.v1.batch.BatchService.create_job", new_callable=AsyncMock) as mock_create:
...
async def test_list_batch_jobs():
    ...
    with patch("aml_filter.api.v1.batch.BatchService.list_jobs", new_callable=AsyncMock) as mock_list:
