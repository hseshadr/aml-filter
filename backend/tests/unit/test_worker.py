...
async def test_screen_whitelist_on_blacklist_update(mock_service_class, mock_create_db):
    ...
    mock_create_db.return_value.async_session_maker.return_value.__aenter__.return_value = mock_session
    ...
    mock_service.screen_whitelist_against_blacklist.return_value = {"entities_scanned": 1, "matches_found": 0}
...
async def test_screen_whitelist_on_blacklist_update_with_job_id(mock_service_class, mock_create_db):
    ...
    mock_service = AsyncMock()
    mock_service_class.return_value = mock_service
    mock_service.screen_whitelist_against_blacklist.return_value = {"entities_scanned": 5, "matches_found": 1}
