...
public class VectorSpace implements Serializable {
    ...
    private List<VectorData4Tree> mOrphanList = new ArrayList<VectorData4Tree>();
    private List<VectorData4Tree> mVectorList = new ArrayList<VectorData4Tree>();
...
//		setVectorManager	( new VectorManager() );
    ...
    public boolean addVector(final String pIncomingData) {
        ...
        try {
            ...
            VectorData4Tree newVector = createVector(pIncomingData);
     ...
     * @return
     */
    public boolean addVector(final VectorData4Tree pIncomingVectorData) {
        boolean retVal = true;
     ...
     * @return
     */
    public boolean addVector(final VectorData4Tree pIncomingVectorData, final VectorData4Tree pParentVectorData) {
        boolean retVal = true;
    ...
    public void addChild(VectorData4Tree pParent, VectorData4Tree pVectorToAdd) {
        // If no child vs
    ...
    public void addChild(VectorData4Tree pParent, VectorData4Tree pVectorToAdd, double pTrainingDistance) {
        addChild(pParent, pVectorToAdd);
        pParent.getVectorSpace().setTrainSimilarityBoundary(pTrainingDistance);
    }

    public void addChild(VectorData4Tree pParent, double pSimilarityToParent, VectorData4Tree pVectorToAdd) {
    ...
    public boolean isFirstVectorMoreCentered(
            VectorData4Tree pFirstVector,
            VectorData4Tree pSecondVector,
...
//		int i=1;
    ...
    public VectorSpace clone() {
        ...
        for (int i = 0; i < size(); i++) {
            VectorData4Tree newVd = getVectorList().get(i).clone();
     ...
     * @throws Exception
     */
    public VectorData4Tree createVector(final String pIncomingString) throws Exception {
     ...
     * @throws Exception
     */
    public VectorData4Tree createVector(final String pIncomingString,
    ...
    public VectorData4Tree findParentWithZeroMaxDistDrillDown() {
    ...
    public VectorData4Tree get(int pPosition) {
    ...
    public List<VectorData4Tree> getOrphanList() {
        return mOrphanList;
    }

    public void setOrphanList(List<VectorData4Tree> pOrphanList) {
    ...
    public List<VectorData4Tree> getVectorList() {
        return mVectorList;
    }

    public void setVectorList(List<VectorData4Tree> vectorSpace) {
...
//		}
    ...
    public double obtainSimilarity(VectorData4Tree pVector1, VectorData4Tree pVector2) throws Exception {
    ...
    public double obtainSimilarityUsingTrainingComparator(VectorData4Tree pVector1, VectorData4Tree pVector2) throws Exception {
    ...
    public List<TreeResult> obtainSimilarResults(VectorData4Tree pSearchVectorData,
                                                 int pMaxResults,
                                                 double pMinSimilarityAllowed,
    ...
    public List<TreeResult> treeSearch_old(VectorData4Tree pSearchVectorData,
                                           int pMaxResults,
                                           double pMinSimilarityAllowed,
