...
import org.gainratio.amlfilter.vector.dataFiles.VectorLoader_tiny;
...
//			show_refVectors_densities(critVs, vs);
            ...
            VectorData targetRefurbishedVector = vs.createVector("ECHEBARRIA SMARRO LERE");
        ...
        for (int i = 0; i < pReferenceVs.size(); i++) {
            ...
            for (int pass = 0; pass < pNumPasses; pass++) {
                ...
                if (pReferenceVs.get(i).isMarked()) {
                    ...
                    VectorData criteriaVector = pWorldVs
