...
//		        	}
     ...
     * @return
     */
    public final static double computeAverageCosine(int pRefVector, List<VectorData> pVectorDataList, int pStartOffset, int pLength) {
        double retVal = -1d;
        ...
        double partialCosineSum = 0d;
        int count = 0;
        VectorData refVectorData = pVectorDataList.get(pRefVector);
